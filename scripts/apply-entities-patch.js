...
try {
  ...
  // ensure decode and escape entry points exist
  ...
  // keep existing lib entries
  pkg.exports['./lib/decode.js'] = pkg.exports['./lib/decode.js'] || { require: './lib/decode.js', import: './lib/esm/decode.js' };
  pkg.exports['./lib/escape.js'] = pkg.exports['./lib/escape.js'] || { require: './lib/escape.js', import: './lib/esm/escape.js' };
