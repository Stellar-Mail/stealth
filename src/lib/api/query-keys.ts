...
export const cacheInvalidations = {
  sessionLogout: () => [queryKeys.auth.session, queryKeys.auth.bootstrap],
  sessionRenew: () => [queryKeys.auth.session, queryKeys.auth.bootstrap],
  bootstrapChange: () => [queryKeys.auth.bootstrap],
