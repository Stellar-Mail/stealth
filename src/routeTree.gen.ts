...
import { Route as ApiV1AuthUsernameCheckRouteImport } from './routes/api/v1/auth/username/check'
import { Route as ApiV1AuthUsernameReserveRouteImport } from './routes/api/v1/auth/username/reserve'
...
const ApiV1AuthUsernameCheckRoute = ApiV1AuthUsernameCheckRouteImport.update({
  id: '/api/v1/auth/username/check',
  path: '/api/v1/auth/username/check',
  getParentRoute: () => rootRouteImport,
} as any)
const ApiV1AuthUsernameReserveRoute =
  ApiV1AuthUsernameReserveRouteImport.update({
    id: '/api/v1/auth/username/reserve',
    path: '/api/v1/auth/username/reserve',
    getParentRoute: () => rootRouteImport,
  } as any)
...
export interface FileRoutesByFullPath {
  ...
  '/api/v1/auth/username/check': typeof ApiV1AuthUsernameCheckRoute
  '/api/v1/auth/username/reserve': typeof ApiV1AuthUsernameReserveRoute
...
export interface RootRouteChildren {
  ...
  ApiV1AuthUsernameCheckRoute: typeof ApiV1AuthUsernameCheckRoute
  ApiV1AuthUsernameReserveRoute: typeof ApiV1AuthUsernameReserveRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/api/v1/auth/username/check': {
      id: '/api/v1/auth/username/check'
      path: '/api/v1/auth/username/check'
      fullPath: '/api/v1/auth/username/check'
      preLoaderRoute: typeof ApiV1AuthUsernameCheckRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/api/v1/auth/username/reserve': {
      id: '/api/v1/auth/username/reserve'
      path: '/api/v1/auth/username/reserve'
      fullPath: '/api/v1/auth/username/reserve'
      preLoaderRoute: typeof ApiV1AuthUsernameReserveRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/api/v1/contacts/import/commit': {
      id: '/api/v1/contacts/import/commit'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  ApiV1AuthUsernameCheckRoute: ApiV1AuthUsernameCheckRoute,
  ApiV1AuthUsernameReserveRoute: ApiV1AuthUsernameReserveRoute,
