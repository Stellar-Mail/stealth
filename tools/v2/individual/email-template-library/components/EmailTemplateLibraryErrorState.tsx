...
interface EmailTemplateLibraryErrorStateProps {
  details?: string;
  onRetry?: () => void;
  title?: string;
}

export function EmailTemplateLibraryErrorState({
  details = "Template library could not load. Verify the template catalog and try again.",
  onRetry,
  title = "Template library error",
}: EmailTemplateLibraryErrorStateProps) {
  return (
    <section
      aria-label="Email template library error"
...
export type { EmailTemplateLibraryErrorStateProps };
