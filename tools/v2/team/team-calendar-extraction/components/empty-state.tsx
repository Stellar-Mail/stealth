 ...
 *
 * Accessible empty state for when no calendar events exist.
 *
 * Accessibility features:
 * - role="status" announces state change to screen readers
 * - Semantic heading hierarchy
 * - Clear descriptive text for context
